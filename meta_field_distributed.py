...
Bootstrap: fetch last known-good source, apply all runtime patches, run.
No placeholder. Full HMC body lives at commit 4588681 until a full in-tree
blob can be committed in one shot.
